...
namespace SeleniumApplication.Tests.Input
{
    public class SimpleForm
    {
        ...
        public void CheckUrl()
        {
            ...
            Helpers.AssertTrue(driver,url == "https://www.seleniumeasy.com/test/basic-first-form-demo.html", "Page not exist");
        }
        ...
        public void InputNonNumberTextToSumTextBoxForm(string inputId)
        {
            ...
            Helpers.AssertTrue(driver,result == "", $"Textbox {inputId} test failed. Value should be a number. \n Expected:\n Current: {result}");
        }
        ...
        public void SendMessageToFormGetInput(string text)
        {
            ...
            Helpers.AssertTrue(driver,result == text, $"Test failed. \n Expected: {text} \n Current: {result} ");
        }
        ...
        public void SendMessageToFormGetTotal(string valueA, string valueB, string sum)
        {
            ...
            Helpers.AssertTrue(driver,result == sum, $"Test failed. \n Expected: {sum} \n Current: {result} ");
        }
    }
}
